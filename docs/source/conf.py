...
# movie_poster_classifier documentation build
...
from movie_poster_classifier import __version__ as release

# -- Project information -----------------------------------------------------

project = "movie_poster_classifier"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "movie_poster_classifierdoc"
...
latex_documents = [
    (
        master_doc,
        "movie_poster_classifier.tex",
        "movie_poster_classifier Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "movie_poster_classifier",
        "Project movie_poster_classifier codebase.",
        "Data-Science",
    )
]
